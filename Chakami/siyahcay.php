...
// Siyah çayları veritabanından seç
$sql = "SELECT * FROM urun_liste WHERE product_type = 'Siyah Çay'";
...
<head>
    ...
    <title> Siyah Çay | Chakami </title>
    <link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <link rel="stylesheet" type="text/css" href="assets/css/siyahcay.css">
</head>
...
<body>
    ...
    <div class="container">
        <h1 class="text-center my-4">Siyah Çaylar</h1>
        <div class="row">
    ...
    <script src="assets/js/siyahcay.js"></script>
