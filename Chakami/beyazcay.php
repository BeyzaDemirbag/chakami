...
// Beyaz çayları veritabanından seç
$sql = "SELECT * FROM urun_liste WHERE product_type = 'Beyaz Çay'";
...
<title> Beyaz Çay | Chakami </title>
<link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
<link rel="stylesheet" type="text/css" href="assets/css/beyazcay.css">
</head>
...
<div class="profile-popup-content">
    ...
    <div class="container">
        <h1 class="text-center my-4">Beyaz Çaylar</h1>
        <div class="row">
    ...
    <script src="assets/js/beyazcay.js"></script>
