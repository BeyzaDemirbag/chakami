...
// Yeşil çayları veritabanından seç
$sql = "SELECT * FROM urun_liste WHERE product_type = 'Yeşil Çay'";
...
<head>
    ...
    <title> Yeşil Çay | Chakami </title>
    <!-- Bootstrap CSS -->
    <link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <link rel="stylesheet" type="text/css" href="assets/css/yesilcay.css">
</head>
...
<body>
    ...
    <div class="container">
        <h1 class="text-center my-4">Yeşil Çaylar</h1>
        <div class="row">
    ...
    <script src="assets/js/oolong.js"></script>
