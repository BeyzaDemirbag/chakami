...
$sql = "SELECT * FROM urun_liste WHERE product_type = 'Oolong'";
...
<head>
    ...
    <title> Oolong | Chakami </title>
    <link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <link rel="stylesheet" type="text/css" href="assets/css/oolong.css">
</head>
...
<body>
    ...
    <div class="container">
        <h1 class="text-center my-4">Oolong</h1>
        <div class="row">
